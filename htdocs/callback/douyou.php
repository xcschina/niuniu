...
//$orderid = paramUtils::strByPOST("orderid",false);
//$username = paramUtils::strByPOST("username",false);
//$gameid = paramUtils::intByPOST("gameid",false);
//$roleid = paramUtils::strByPOST("roleid",false);
//$serverid = paramUtils::intByPOST("serverid",false);
//$paytype = paramUtils::strByPOST("paytype",false);
//$amount = paramUtils::intByPOST("amount",false);
//$paytime = paramUtils::intByPOST("paytime",false);
//$attach = paramUtils::strByPOST("attach",false);
