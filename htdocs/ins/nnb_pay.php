...
if(!$params['usr_id'] || !$params['app_id'] || !$params['player_id'] || !$params['serv_id'] ||  !$params['money_id']){
    ...
    $api->err_log(var_export($params,1),'nnb_pay_cp_log');
}
try{
    $api->nnb_pay();
}catch (Exception $e){
    $api->err_log(var_export($params,1),"nnb-pay-android-secure-pay");
    $api->err_log(var_export($e,1),"nnb-pay-android-secure-pay");
}
