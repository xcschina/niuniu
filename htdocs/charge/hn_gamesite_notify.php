...
$alipay = new alipay_notify(HN_ALI_MOBILE_partner, HN_ALI_MOBILE_key, HN_ALI_MOBILE_sec_id, HN_ALI_MOBILE_input_charset); // 构造通知函数信息
        ...
        if ($status == 'TRADE_FINISHED' || $status == 'TRADE_SUCCESS') {
            ...
            if(!$dao->result){
                ...
                if($order['status']!=2){
                    ...
                    $dao->params = array($ali_order_id, 1, $buyer_email, strtotime($pay_time),2,$order_id);
                    $dao->doExecute();
                }
                echo "success";
            }
