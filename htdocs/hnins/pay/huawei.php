...
$api->err_log(var_export($params,1),"h5_super_ch_order");
...
try{
    ...
    $api->err_log(var_export($params,1),"h5_super_ch_order_error");
    $api->err_log(var_export($e,1),"h5_super_ch_order_error");
}
