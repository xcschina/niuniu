...
$params = $_POST;
$result = array("result" => 0, "desc" => "网络异常1");
if(empty($params)){
    die(json_encode($result));
}
$api->err_log(var_export($params,1),"h5_hwquick_order");
...
try{
    ...
    $api->err_log(var_export($params,1),"h5_hwquick_order_error");
    $api->err_log(var_export($e,1),"h5_hwquick_order_error");
}
