(function() {
	...
	function init() {
		...
		setInterval(function(){if(allow){navigate( 'next' );}},3000);
		component.addEventListener( 'mouseover', function( ev ) { allow=false; } );
		component.addEventListener( 'mouseout', function( ev ) { allow=true; } );
	}
