...
class orders_info_dao extends Dao {
    ...
    public function get_orders_list($page,$params){
        $this->limit_sql="select ord.*,pro.type,pro.user_id,b.game_name,a.real_name from orders ord inner join products pro on ord.product_id=pro.id
    ...
    public function get_order_imgs($order_id){
        $this->sql="select * from order_imgs where order_id=? and is_del=0";
