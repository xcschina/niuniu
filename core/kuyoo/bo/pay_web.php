...
class pay_web extends baseKuyoo {
    ...
    public function ali_pay($product){
        ...
        $alipay->return_url     = "http://shouyou.kuyoo.com/ali_return.php";
        $alipay->out_trade_no   = $product->order_id;
        $alipay->show_url       = "http://shouyou.kuyoo.com/";
    ...
    public function wx_pay($product){
        ...
        if($res['status']){
            ...
            $msg = '<br><a href="http://shouyou.kuyoo.com/games/'.$product->game_id.'.html">点此返回</a>';
            die($res['msg'].$msg);
        }
    }
