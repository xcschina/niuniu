...
class account_dao extends Dao{
    ...
    public function insert_user_info($password, $mobile, $reg_ip, $qq_id=''){
        ...
        if($qq_id<>""){
            ...
            $user_login = array("user_id"=>$user_id,"login_name"=>$login_name,"user_name"=>"","password"=>$password,"mobile"=>$mobile,"login_type"=>1,"token"=>"","nick_name"=>"","id_number"=>"","age"=>0);
        }else{
            $user_login = array("user_id"=>$user_id,"login_name"=>$mobile,"user_name"=>"","password"=>$password,"mobile"=>$mobile,"login_type"=>1,"token"=>"","nick_name"=>"","id_number"=>"","age"=>0);
        }
        $user_info = array("user_id"=>$user_id,"guid"=>$guid,"reg_time"=>strtotime("now"),"reg_ip"=>$reg_ip,"qq_id"=>$qq_id,"buy_mobile"=>$mobile,"reg_from"=>1);
