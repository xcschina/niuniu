...
class website_web extends baseCore{
    ...
    public function cqzx(){
        $this->display("website/cqzx/index.html");
    }
    public function cqll(){
        $this->display("website/cqll/index.html");
    }
    public function cqll2(){
        $this->display("website/cqll2/index.html");
    }
    public function cqsb(){
        $this->display("website/cqsb/index.html");
    }
    public function cqtt(){
        $this->display("website/cqtt/index.html");
    }
    public function cqwb(){
        $this->display("website/cqwb/index.html");
    }
    public function cqtl(){
        $this->display("website/cqtl/index.html");
    }
}