...
DAO('activity_info_dao');
class activity_info_mobile extends baseCore{
    public $DAO;
    public $COMDAO;

    public function __construct(){
        parent::__construct();
        $this->DAO = new activity_info_dao();
