...
class integral_dao extends Dao{
    ...
    public function get_user_info($user_id){
        $this->sql = "select a.*,b.integral,b.exp from user_info a left join user_relation_tb b on a.user_id = b.user_id where a.user_id=?";
    ...
    public function get_user_message($user_id){
        $this->sql = "select * from user_relation_tb where user_id = ?";
        $this->params = array($user_id);
        $this->doResult();
        return $this->result;
    }
    ...
    public function get_app_info($app_id){
        ...
        if(!$data){
            $this->sql = "select a.*,b.nnb_scale,b.relation_id from niuniu.apps a left join niuniu.apps_relation_tb b on a.app_id = b.app_id  where a.app_id=? ";
    ...
    public function get_app_message($app_id){
        $this->sql = "select * from niuniu.apps_relation_tb where app_id = ?";
        $this->params = array($app_id);
        $this->doResult();
        return $this->result;
    }
    ...
    public function get_goods_info($goods_id){
        $this->sql = "select * from niuniu.app_goods where id = ?";
